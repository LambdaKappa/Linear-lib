...
_Your compiler should see the path to **'include'** directory. If you are using the g++ compiler,__ 
__create executable to make sure the compiler is aware of the code files inside of this directory._
